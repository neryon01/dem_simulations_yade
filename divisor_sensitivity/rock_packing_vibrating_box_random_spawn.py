...
utils.readParamsFromTable(
    ...
    # Common clump-resolution divisor applied to all four rock templates.
    # Member-sphere radius = rock-template x extent / divisor. The parameter
    # table overrides this default in the divisor-sensitivity study.
    rockResolutionDivisor=10,
    ...
    rockYoung=20.0e9,
    rockPoisson=0.20,
    # Fixed baseline value for every divisor-study run.
...
ROCK_RESOLUTION_DIVISOR = int(table.rockResolutionDivisor)
...
if ROCK_RESOLUTION_DIVISOR < 2:
    raise ValueError("rockResolutionDivisor must be an integer of at least 2.")
...
print("rockResolutionDivisor =", ROCK_RESOLUTION_DIVISOR)
...
# Fixed particle-specific overlap and lattice-rotation settings from geometry
# screening. The study supplies one common divisor for all four rock types.
# Lattice rotation is not the initial orientation of the complete falling rock.
SELECTED_CLUMP_CONFIGURATIONS = {
    1: {"overlapFraction": 0.30, "rotation": "identity"},
    2: {"overlapFraction": 0.30, "rotation": "identity"},
    3: {"overlapFraction": 0.50, "rotation": "identity"},
    4: {"overlapFraction": 0.30, "rotation": "z_30deg"},
}
...
for rock_index, gts_filename in enumerate(ROCK_GTS_FILES, start=1):
    configuration = dict(SELECTED_CLUMP_CONFIGURATIONS[rock_index])
    configuration["divisor"] = ROCK_RESOLUTION_DIVISOR
    ...
    if actual_count < 1:
        raise RuntimeError(
            "No member spheres were generated for rock {} at divisor {}."
            .format(rock_index, ROCK_RESOLUTION_DIVISOR)
        )
...
def write_yade_metrics(
    ...
    metrics = pd.DataFrame([{
        ...
        "rockResolutionDivisor": ROCK_RESOLUTION_DIVISOR,
        ...
        **overlap_metrics,
        ...
        "rock1ResolutionDivisor": ROCK_RESOLUTION_DIVISOR,
        ...
        "rock2ResolutionDivisor": ROCK_RESOLUTION_DIVISOR,
        ...
        "rock3ResolutionDivisor": ROCK_RESOLUTION_DIVISOR,
        ...
        "rock4ResolutionDivisor": ROCK_RESOLUTION_DIVISOR,
