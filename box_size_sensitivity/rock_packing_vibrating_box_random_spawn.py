...
utils.readParamsFromTable(
    ...
    # The bed-size parameter table overrides this value. Only the common x/y
    # half-extent changes; the box remains square and its z geometry is fixed.
    ...
    rockYoung=20.0e9,
    rockPoisson=0.20,
    # Fixed baseline value for every bed-size-study run.
