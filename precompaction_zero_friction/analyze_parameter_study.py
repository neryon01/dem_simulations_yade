...
# Paired gravity-versus-case porosity figure requested for both the
# zero-friction and zero-friction+x-vibration study folders.
plot_gravity_source_porosity_comparison(df)
