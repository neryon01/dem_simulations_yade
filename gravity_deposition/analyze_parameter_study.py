"""Analyse stochastic variation across the final 100 gravity realizations."""
...
INPUT_CSV = (
    sys.argv[1]
    if len(sys.argv) > 1
    else os.path.join(DEFAULT_OUTPUT_FOLDER, "gravity_total_results.csv")
)
...
summary_path = os.path.join(OUTPUT_FOLDER, "gravity_total_summary_statistics.csv")
